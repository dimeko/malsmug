!function(){
    var e = {
        76141: function(e){
            e.exports={
                ...
                article_search_messenger_app_id:27,mode:"production"
            }
        }
    },
    t={};
    ...
    !function(){
        ...
        t=[
            ".mysite-lightweight-app-launcher",
            ".mysite-launcher-frame",
            "#mysite-container",
            ".mysite-messenger",
                ...
                null==(
                    e=function(){
                        if(a()){
                            ...
                            return{
                                major:parseInt(e[1],10),minor:parseInt(e[2],10),patch:parseInt(e[3]||0,10)
                            }
                        }
                        return null
                    }()
        ...
        var c={
            ...
            isSafari: o,
            isElectron: function(){
                var e=i().userAgent||"",t=window.parent||{},n=t.process&&t.versions&&t.versions.electron;return/\sElectron\//.test(e)||n
            },
            isIE: function(){
                var e=i().userAgent||"";
            ...
            isChrome: function(){
                var e=window.chrome,t=i().vendor,n=i().userAgent.indexOf("OPR")>-1,r=i().userAgent.indexOf("Edge")>-1;
                return!!i().userAgent.match("CriOS")||null!=e&&"Google Inc."===t&&!1===n&&!1===r
            },
            isIOS: a,
            isIOS15Safari: function(){
                var e=i().userAgent,t=a(e),n=!!e.match(/WebKit/i);return t&&n&&!e.match(/CriOS/i)&&s()
            },
        ...
        x=function(){
                    ...
                    delete window.__mysiteAssignLocation,
                    delete window.__mysiteReloadLocation
        },
        _=function(){
            if(!window[g]){
                var e=function e(){
        ...
        window.matchMedia&&
        /MSIE JavaScript 10\.0/.test(navigator.userAgent)||
        navigator&&
        navigator.userAgent&&
        b.test(navigator.userAgent)||
        window.isMySiteMessengerSheet||
        y()||
        (
            E(),
            function(e,t,n){
